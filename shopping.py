...
def load_data(filename):
    ...
    with open(filename) as file:
        ...
        for row in reader:
            ...
            # Append the processed evidence and label to their respective lists
...
def evaluate(labels, predictions):
    ...
    specificity = sum(1 for actual, predicted in zip(labels, predictions) if actual == 0 and predicted == 0) / actual_negatives
